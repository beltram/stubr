...
async fn proxy_should_forward_status_200() {
    ...
    assert_recorded_stub_eq("status-200-2265763564283130440", json!({
        "request": {
            "method": "GET",
            "urlPath": "/status/200"
        },
...
async fn proxy_should_forward_status_400() {
    ...
    assert_recorded_stub_eq("status-400-8450859937848383497", json!({
        "request": {
            "method": "GET",
            "urlPath": "/status/400"
        },
...
async fn proxy_should_forward_status_500() {
    ...
    assert_recorded_stub_eq("status-500-7338203501353728751", json!({
        "request": {
            "method": "GET",
            "urlPath": "/status/500"
        },
