...
mod verify_matcher_tests {
    ...
    mod contains {
        ...
        fn should_generate_param_containing_string() {
            let matcher = MatcherValueStub {
                contains: Some(String::from("alpha")),
                ..Default::default()
            };
    ...
    mod matches {
        ...
        fn should_generate_param_matching_string() {
            ...
            let matcher = MatcherValueStub {
                matches: Some(Value::String(regex.clone())),
                ..Default::default()
            };
