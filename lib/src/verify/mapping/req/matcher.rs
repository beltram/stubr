...
use crate::verify::mapping::regex::RegexStub;
...
impl MatcherValueStubMapper {
    ...
    fn map_contains(value: &String) -> Option<String> {
        i64::from_str(&value).ok()
            .map(|v| ContainsGenerator::generate_number_containing(v))
