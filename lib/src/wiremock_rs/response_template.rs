...
pub struct ResponseTemplate {
    pub(crate) mime: Option<http_types::Mime>,
    pub(crate) http_status_code: Option<StatusCode>,
    #[cfg(feature = "grpc")]
    pub(crate) grpc_status_code: Option<tonic::Code>,
...
impl ResponseTemplate {
    ...
    {
        Self {
            http_status_code: s.try_into().ok(),
            ..Default::default()
        }
    }
    ...
    pub fn set_body_json<B: Serialize>(mut self, body: B) -> Self {
        ...
        self.body = Some(body);
        self.mime = Some(http_types::Mime::from_str("application/json").expect("Failed to convert into Mime header"));
        self
    }
        ...
        <T as TryInto<String>>::Error: std::fmt::Debug,
    {
        ...
        self.mime = Some(http_types::Mime::from_str("text/plain").expect("Failed to convert into Mime header"));
        self
    }
        ...
        <B as TryInto<Vec<u8>>>::Error: std::fmt::Debug,
    {
        let body = body.try_into().expect("Failed to convert into body.");
        self.body = Some(body);
        self.mime = Some(http_types::Mime::from_str(mime).expect("Failed to convert into Mime header"));
        self
    }
